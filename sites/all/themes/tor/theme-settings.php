 ...
 */
function tor_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['tor_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('tor sample setting'),
  '#default_value' => theme_get_setting('tor_example'),
